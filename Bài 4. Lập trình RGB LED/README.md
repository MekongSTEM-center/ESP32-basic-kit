...
1. **Cathode Chung (Common Cathode - CC):**
   * Chân chung nối về cực Âm (**GND**).
   * Xuất mức điện áp cao (HIGH/PWM) vào chân màu nào thì màu đó sẽ sáng.
2. **Anode Chung (Common Anode - CA):**
   * Chân chung nối về cực Dương (**3.3V/5V**).
...
* 1 x Đèn LED RGB 5mm (Cathode chung).
