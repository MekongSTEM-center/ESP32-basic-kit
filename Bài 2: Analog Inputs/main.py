...
# 1. Cấu hình chân đọc tín hiệu Analog (ADC Input)
# Sử dụng chân GPIO4 theo đúng sơ đồ mặc định của bộ kit (Kênh ADC2_CH0)
pot = ADC(Pin(4))
...
try:
    ...
    while True:
        ...
        # Chu kỳ lấy mẫu dữ liệu sau mỗi 0.5 giây (500ms) để tránh tràn bộ đệm hiển thị
        sleep(0.5)        
